...
export const githubRepos: GitHubRepo[] = [
  ...
  { id: "repo-32", name: "SWMM-Lego-Model", description: "SWMM5 model built from modular Lego-style reusable network components.", url: "https://github.com/dickinsonre/SWMM-Lego-Model", language: "", stars: 0, fork: false, updatedAt: "2026-05-12", categories: ["SWMM5"] },
  ...
  { id: "repo-55", name: "ForceMainSWMM5EPANETComparison", description: "Python tool comparing force main hydraulics between SWMM5 and EPANET simulations.", url: "https://github.com/dickinsonre/ForceMainSWMM5EPANETComparison", language: "Python", stars: 0, fork: false, updatedAt: "2026-05-13", categories: ["SWMM5"] },
  { id: "repo-56", name: "Stormcraft-Ultimate", description: "Stormcraft Ultimate — interactive stormwater modeling and design platform built on Replit.", url: "https://github.com/dickinsonre/Stormcraft-Ultimate", language: "TypeScript", stars: 0, fork: false, updatedAt: "2026-05-13", categories: ["SWMM5"] },
  ...
  { id: "repo-61", name: "SWMM-Engine", description: "SWMM Engine — core SWMM5 simulation engine interface built on Replit.", url: "https://github.com/dickinsonre/SWMM-Engine", language: "", stars: 0, fork: false, updatedAt: "2026-05-13", categories: ["SWMM5"] },
  { id: "repo-62", name: "SWMM-INP-Maker", description: "SWMM INP Maker — interactive builder for SWMM5 input files.", url: "https://github.com/dickinsonre/SWMM-INP-Maker", language: "TypeScript", stars: 0, fork: false, updatedAt: "2026-05-13", categories: ["SWMM5"] },
...
export const swmmEnablementRepos: GitHubRepo[] = [
  { id: "se-1", name: "rain-canvas-studio", description: "Interactive rain canvas studio for stormwater rainfall visualization and analysis.", url: "https://github.com/SWMMEnablement/rain-canvas-studio", language: "TypeScript", stars: 0, fork: false, updatedAt: "2026-05-11", categories: ["SWMM5"] },
  { id: "se-2", name: "Open-Source-Support1", description: "Open code for Innovyze products that support scripting — Ruby for the UI/Exchange, SQL and other useful utilities.", url: "https://github.com/SWMMEnablement/Open-Source-Support1", language: "AGS Script", stars: 0, fork: true, updatedAt: "2026-05-09", categories: ["Ruby Scripting", "ICM InfoWorks"] },
  { id: "se-3", name: "1729-SWMM5-Models", description: "A collection of 1,729 SWMM5 model files covering a wide range of stormwater scenarios.", url: "https://github.com/SWMMEnablement/1729-SWMM5-Models", language: "Batchfile", stars: 9, fork: false, updatedAt: "2026-04-24", categories: ["SWMM5", "History"] },
  { id: "se-4", name: "WCH_2004_SWMM44H", description: "SWMM 4.4H Fortran source code — the 2004 WCH release of the legacy SWMM4 engine.", url: "https://github.com/SWMMEnablement/WCH_2004_SWMM44H", language: "Fortran", stars: 1, fork: false, updatedAt: "2026-04-06", categories: ["SWMM5", "History"] },
  { id: "se-5", name: "openswmm.engine", description: "Dynamic hydrology-hydraulic water quality simulation model for stormwater, wastewater, and combined sewer collection systems.", url: "https://github.com/SWMMEnablement/openswmm.engine", language: "", stars: 0, fork: true, updatedAt: "2026-03-25", categories: ["SWMM5"] },
  { id: "se-6", name: "SWMM_MD_Documents", description: "Curated collection of SWMM reference documentation and technical notes in Markdown format.", url: "https://github.com/SWMMEnablement/SWMM_MD_Documents", language: "Fortran", stars: 1, fork: false, updatedAt: "2026-02-10", categories: ["SWMM5"] },
  { id: "se-7", name: "pyswmm", description: "Python wrappers for EPA SWMM enabling scripted simulation control and results extraction.", url: "https://github.com/SWMMEnablement/pyswmm", language: "Python", stars: 0, fork: true, updatedAt: "2026-02-10", categories: ["SWMM5", "Code Analysis"] },
  { id: "se-8", name: "Hackathon_KM", description: "Ruby-based knowledge management scripts from a SWMM stormwater modeling hackathon.", url: "https://github.com/SWMMEnablement/Hackathon_KM", language: "Ruby", stars: 0, fork: false, updatedAt: "2025-10-22", categories: ["Ruby Scripting"] },
  { id: "se-9", name: "Stormwater-Management-Model", description: "Dynamic hydrology-hydraulic water quality simulation model — Open Water Analytics SWMM fork.", url: "https://github.com/SWMMEnablement/Stormwater-Management-Model", language: "", stars: 0, fork: true, updatedAt: "2024-03-05", categories: ["SWMM5"] },
  { id: "se-10", name: "Open-Source-Support", description: "Open code for Innovyze products that support scripting — Ruby for the UI/Exchange, SQL and other useful utilities.", url: "https://github.com/SWMMEnablement/Open-Source-Support", language: "AGS Script", stars: 0, fork: true, updatedAt: "2024-02-26", categories: ["Ruby Scripting", "ICM InfoWorks"] },
  { id: "se-11", name: "SWMM5plus", description: "Prototype Fortran 2008 engine for the EPA Storm Water Management Model (SWMM).", url: "https://github.com/SWMMEnablement/SWMM5plus", language: "Fortran", stars: 0, fork: true, updatedAt: "2023-01-17", categories: ["SWMM5"] },
  { id: "se-12", name: "swmmr", description: "R language interface for US EPA's SWMM — run simulations and read results from R.", url: "https://github.com/SWMMEnablement/swmmr", language: "R", stars: 0, fork: true, updatedAt: "2022-11-01", categories: ["SWMM5", "Code Analysis"] }
];

export const swmmBobRepos: GitHubRepo[] = [
  { id: "bob-1", name: "swmm5-runoff-explorer", description: "SWMM5 runoff parameter explorer and sensitivity analysis tool.", url: "https://github.com/SWMMBobSWMM6/swmm5-runoff-explorer", language: "HTML", stars: 0, fork: false, updatedAt: "2026-05-02", categories: ["SWMM5"] },
  { id: "bob-2", name: "openswmm.engine", description: "Dynamic hydrology-hydraulic water quality simulation model for stormwater, wastewater, and combined sewer collection systems.", url: "https://github.com/SWMMBobSWMM6/openswmm.engine", language: "", stars: 2, fork: true, updatedAt: "2026-03-30", categories: ["SWMM5"] }
];
