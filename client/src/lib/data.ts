...
export const linkedInPosts: LinkedInPost[] = [
  ...
  },
  {
    ...
    date: "2025",
    link: "https://www.linkedin.com/posts/samer-muhandes_infoworksicm-didyouknowicmcandothat-ugcPost-7460948710970257409--EST",
    categories: ["ICM InfoWorks"],
    imageUrl: icmCover
  },
  {
...
export const githubRepos: GitHubRepo[] = [
  ...
  { id: "repo-70", name: "HindsightProphet", description: "Hindsight Prophet — retrospective forecasting and analysis tool built on Replit.", url: "https://github.com/dickinsonre/HindsightProphet", language: "TypeScript", stars: 0, fork: false, updatedAt: "2026-05-21", categories: ["Code Analysis"] },
  { id: "repo-71", name: "awi-github-viewer", description: "HTML viewer for the Autodesk Water Infrastructure (Innovyze) GitHub repositories.", url: "https://github.com/dickinsonre/awi-github-viewer", language: "HTML", stars: 0, fork: false, updatedAt: "2026-05-24", categories: ["ICM InfoWorks", "Code Analysis"] }
];
...
export const swmmEnablementRepos: GitHubRepo[] = [
  ...
  { id: "se-32", name: "RubyMakerAI", description: "AI-powered Ruby script generator for InfoWorks ICM Exchange — built on Replit.", url: "https://github.com/SWMMEnablement/RubyMakerAI", language: "TypeScript", stars: 0, fork: false, updatedAt: "2026-05-20", categories: ["Ruby Scripting", "ICM InfoWorks"] },
  { id: "se-33", name: "RubyFileLister", description: "Ruby script file lister and organizer for ICM Exchange scripting projects.", url: "https://github.com/SWMMEnablement/RubyFileLister", language: "TypeScript", stars: 0, fork: false, updatedAt: "2026-05-20", categories: ["Ruby Scripting", "ICM InfoWorks"] }
];
