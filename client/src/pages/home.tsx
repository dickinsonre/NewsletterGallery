                ...
                <div className="space-y-6 py-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap justify-center gap-2 text-sm">
                      <span className="bg-secondary px-3 py-1 rounded-full text-secondary-foreground">SWMM (48+ yrs)</span>
            ...
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="text-center md:text-left flex-grow">
                ...
                <p className="text-muted-foreground mb-3">
                  <span className="font-medium text-foreground">48+ years documenting stormwater modeling</span> — from SWMM 2.5 punch cards in 1978 to AI-integrated ICM InfoWorks today. 
